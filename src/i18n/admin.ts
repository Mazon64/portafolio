...
export const adminCopy = {
  es: {
    ...
    documents: {
      ...
      unsavedDescription: "Revisa y modifica el contenido redactado. Los datos canónicos se incorporarán desde el portafolio al guardar.",
      ...
      actionStatus: { idle: "", generated: "Borrador generado. Revísalo antes de guardarlo.", success: "Operación completada.", invalid: "Revisa los campos.", disabled: "Las escrituras están deshabilitadas en este entorno.", unavailable: "La generación de documentos no está configurada.", conflict: "Las fuentes cambiaron mientras editabas. Genera un borrador nuevo.", error: "No fue posible completar la operación." },
    },
  },
  en: {
    ...
    documents: {
      ...
      unsavedDescription: "Review and edit the drafted content. Canonical data will be added from the portfolio when you save.",
      ...
      actionStatus: { idle: "", generated: "Draft generated. Review it before saving.", success: "Operation completed.", invalid: "Review the fields.", disabled: "Writes are disabled in this environment.", unavailable: "Document generation is not configured.", conflict: "The sources changed while you were editing. Generate a new draft.", error: "The operation could not be completed." },
    },
  },
