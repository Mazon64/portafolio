...
* **RF-04.3: CV ATS.** Cada solicitud debe poder generar, revisar y editar antes del guardado un CV ATS de una columna adaptado a una vacante y descargable como PDF y DOCX.
