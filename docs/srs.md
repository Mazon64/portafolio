...
* **RF-04.3: CV ATS.** Cada solicitud debe poder generar, revisar y editar antes del guardado un CV ATS de una columna adaptado a una vacante y descargable como PDF profesional en tamaño Carta.
...
* **RF-04.5: Historial Permanente.** Solicitudes, contextos y artefactos deben conservarse como versiones append-only sin operaciones de borrado desde el CMS. El historial debe actualizarse después de guardar sin una recarga manual y presentarse paginado.
