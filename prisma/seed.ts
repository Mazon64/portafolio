      ...
      const profileTranslations = [
        {
          ...
          longBio: "Soy ingeniero de software especializado en desarrollo backend, arquitectura de sistemas e integración de inteligencia artificial. He desarrollado aplicaciones empresariales y sistemas institucionales, desde el diseño hasta el despliegue en producción.\n\nTrabajo con Node.js, bases de datos relacionales, APIs, Docker y arquitecturas modulares. Priorizo la mantenibilidad, la seguridad y la escalabilidad. He implementado sistemas de autenticación multi-tenant y federada, diseñado APIs seguras e integrado modelos de lenguaje (LLMs) en aplicaciones empresariales mediante ingeniería de prompts, programación determinista con LLMs y contexto en tiempo real.",
          contactText: "¿Quieres hablar sobre una oportunidad, una colaboración o un proyecto? Cuéntame los detalles en el formulario y te responderé lo antes posible.",
        },
        {
          locale: Locale.EN,
          title: "Software Engineer",
          longBio: "I am a software engineer specializing in backend development, system architecture, and artificial intelligence integration. I have developed enterprise and institutional applications from initial design through production deployment.\n\nI work with Node.js, relational databases, APIs, Docker, and modular architectures. I prioritize maintainability, security, and scalability. I have implemented multi-tenant and federated authentication systems, designed secure APIs, and integrated Large Language Models (LLMs) into enterprise applications using prompt engineering, deterministic LLM programming, and real-time context.",
          contactText: "Would you like to discuss an opportunity, collaboration, or project? Share the details in the form and I will get back to you as soon as possible.",
        },
      ];
